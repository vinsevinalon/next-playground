...
export default function PlaygroundPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {showMetrics && (
        <div className="fixed top-6 right-6 z-40 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-lg p-4 shadow-lg border border-white/20 min-w-[200px]">
          ...
          <div className="space-y-2 text-xs">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                <span className="fps-counter font-mono">60 FPS</span>
                <div className="w-3 h-3 rounded-full bg-green-500 animate-pulse"></div>
              </div>
            </div>
            <div className="flex justify-between items-center">
              <span>Velocity:</span>
              <span className="scroll-velocity font-mono">0</span>
            </div>
            <div className="flex justify-between items-center">
              <span>Progress:</span>
              <span className="scroll-percentage font-mono">0%</span>
            </div>
            <div className="flex justify-between items-center">
              <span>Direction:</span>
              <div className="flex items-center gap-1">
                <span className="scroll-direction">—</span>
                <span className="scroll-direction-text text-[10px]">Neutral</span>
              </div>
            </div>
            <div className="mt-2 pt-2 border-t border-white/20">
              <div className="text-[10px] text-muted-foreground mb-1">Scroll Progress</div>
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
                <div className="scroll-progress-bar bg-gradient-to-r from-blue-500 to-purple-500 h-1.5 rounded-full transition-all duration-150" style={{width: '0%'}}></div>
              </div>
            </div>
            <div className="mt-2">
              <div className="text-[10px] text-muted-foreground mb-1">Velocity</div>
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1">
                <div className="velocity-bar bg-gradient-to-r from-green-500 to-yellow-500 h-1 rounded-full transition-all duration-150" style={{width: '0%'}}></div>
              </div>
            </div>
          </div>
        </div>
